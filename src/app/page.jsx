...
export default function Home() {
  return (
    <div className="max-w-[700px] mx-auto mt-[30px] in:mt-[250px] flex flex-col items-center p-4">
      ...
      {/* <div className="flex flex-col gap-4 border border-zinc-700 rounded-lg p-4 max-w-[400px] w-full">
        <a href="https://siter.kz/" target="_blank" className="text-center p-4 bg-[#2378be] rounded-full text-white font-bold hover:opacity-90">Siter.kz</a>
        <a href="https://hoster.kz/" target="_blank" className="text-center p-4 bg-orange-600 rounded-full text-white font-bold hover:opacity-90">Hoster.kz</a>
